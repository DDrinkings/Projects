export default {
    ...
    'Diamond Demo': '钻石演示',
    '请输入金额': '请输入金额',
    '下单金额范围为0.01至50000之间': '下单金额范围为0.01至50000之间',
    '请填写正确的备注信息, 否则无法到账!!!': '请填写正确的备注信息, 否则无法到账!!!',
    '下单成功': '下单成功',
    '下单失败, 请稍候重试': '下单失败, 请稍候重试',
    '支付宝': '支付宝',
    '转到支付宝账户': '转到支付宝账户',
    '请填写您转账的支付宝账号': '请填写您转账的支付宝账号',
    '请填写您的付款账户姓名': '请填写您的付款账户姓名',
    '请填写您的银行卡付款账户姓名': '请填写您的银行卡付款账户姓名',
    '请填写您转账的微信账号': '请填写您转账的微信账号',
    '金额': '金额',
    '元': '元',
    '银行卡': '银行卡',
    '支付宝转银行卡': '支付宝转银行卡',
