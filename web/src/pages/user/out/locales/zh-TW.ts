export default {
  ...
  'Diamond Demo': '鉆石演示',
  '请输入金额': '請輸入金額',
  '下单金额范围为0.01至50000之间': '下單金額範圍為0.01至50000之間',
  '请填写正确的备注信息, 否则无法到账!!!': '請填寫正確的備註信息, 否則無法到賬!!!',
  '下单成功': '下單成功',
  '下单失败, 请稍候重试': '下單失敗, 請稍候重試',
  '支付宝': '支付寶',
  '转到支付宝账户': '轉到支付寶賬戶',
  '请填写您转账的支付宝账号': '請填寫您轉賬的支付寶賬號',
  '请填写您的付款账户姓名': '請填寫您的付款賬戶姓名',
  '请填写您的银行卡付款账户姓名': '請填寫您的銀行卡付款賬戶姓名',
  '请填写您转账的微信账号': '請填寫您轉賬的微信賬號',
  '金额': '金額',
  '元': '元',
  '银行卡': '銀行卡',
  '支付宝转银行卡': '支付寶轉銀行卡',
