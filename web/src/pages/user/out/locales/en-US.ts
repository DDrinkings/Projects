export default {
    ...
    'menu.in': 'Diamond Demo',
    'Diamond Demo': 'Diamond Demo',
    '请输入金额': 'Please input the amount',
    '下单金额范围为0.01至50000之间': 'The amount of the order ranges from 0.01 to 50000',
    '请填写正确的备注信息, 否则无法到账!!!': 'Please fill in the correct notes, otherwise you can\'t get to the account!!!',
    '下单成功': 'Order success',
    '下单失败, 请稍候重试': 'The order failed. Please try again later',
    '支付宝': 'Alipay',
    '转到支付宝账户': 'to Alipay',
    '请填写您转账的支付宝账号': 'Please fill in the Alipay account for you use',
    '请填写您的付款账户姓名': 'Please fill in the name of your payment account.',
    '请填写您的银行卡付款账户姓名': 'Please fill in the name of your bank card payment account',
    '请填写您转账的微信账号': 'Please fill in your Wechat Pay account for you use',
    '金额': 'Amount',
    '元': 'YUAN',
    '银行卡': 'Bank card',
    '支付宝转银行卡': 'to Bank card',
    '微信': 'WeChat',
    '确认下单': 'OK',
};
